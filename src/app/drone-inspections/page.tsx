    ...
    return (
        <main className='flex flex-col w-full'>
            ...
            <section className='p-4 shadow-sm text-sky-700'>
                ...
                <p className='mb-2'>
                    360dronepro provide a drone inspection service, where we work
                    closely with our clients to meet their individual, drone inspection needs.
                </p>
                <p className='mb-2'>
